...
public class NotebookHashMap {
    ...
    static Map<Integer, Notebook> listaNotebook;
    ...
    public void agregarNotebook(Notebook notebook, Integer num){
        listaNotebook.put(num, notebook);
    }
    
    public void listarNotebooks()
    {
        Iterator i = listaNotebook.keySet().iterator();
        while(i.hasNext()){
            Integer key = (Integer)i.next();
            System.out.println("Clave: " + listaNotebook +" Notebook: "+ listaNotebook.);
        }
    }
